...
const ElectronicCategory = () => {
    ...
    return (_jsx("div", { className: "flex flex-wrap justify-between py-5 lg:px-20 border-b", children: homePage.homePageData?.electricCategories
            .slice(0, isSmallScreen ? 5 : electronics.length)
            .map((item) => (_jsx(ElectronicCategoryCard, { item: item }))) }));
};
