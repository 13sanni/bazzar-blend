...
import {} from "../../types/couponTypes";
import { api } from "../../Config/Api";
const API_URL = "/api/coupons";
// Async thunks
export const createCoupon = createAsyncThunk("coupon/createCoupon", async ({ coupon, jwt }, { rejectWithValue }) => {
    try {
...
export const deleteCoupon = createAsyncThunk("coupon/deleteCoupon", async ({ id, jwt }, { rejectWithValue }) => {
    try {
...
export const fetchAllCoupons = createAsyncThunk("coupon/fetchAllCoupons", async (jwt, { rejectWithValue }) => {
    try {
...
const couponSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            state.loading = false;
            state.coupons = state.coupons.filter((coupon) => coupon._id !== action.meta.arg.id);
        })
