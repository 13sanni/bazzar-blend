...
import {} from "../../types/reviewTypes";
import { api } from "../../Config/Api";
const API_URL = "/api/reviews";
// Async thunks
export const fetchReviewsByProductId = createAsyncThunk("review/fetchReviewsByProductId", async ({ productId }, { rejectWithValue }) => {
    try {
...
export const createReview = createAsyncThunk("review/createReview", async ({ productId, review, jwt, navigate }, { rejectWithValue }) => {
    try {
...
export const updateReview = createAsyncThunk("review/updateReview", async ({ reviewId, review, jwt }, { rejectWithValue }) => {
    try {
...
export const deleteReview = createAsyncThunk("review/deleteReview", async ({ reviewId, jwt }, { rejectWithValue }) => {
    try {
